...
INSERT INTO SALES (SALE_DATE, SALE_AMOUNT, SALE_TAX, SALE_TYPE, PROD_ID, CUST_ID, SALE_COMMISSION, EMP_ID)
	VALUES (CURDATE(), total_amt, tax, sale_type, prod_id, cus_id, emp_commission, emp_id);
...
INSERT INTO SALES (SALE_DATE, SALE_AMOUNT, SALE_TAX, SALE_TYPE, PROD_ID, CUST_ID, SALE_COMMISSION, EMP_ID, SALE_DISCOUNT, DISC_ID)
	VALUES (CURDATE(), total_amt, tax, sale_type, prod_id, cus_id, emp_commission, emp_id, disc_amt, disc_id);
